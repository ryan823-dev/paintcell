...
export const industries: Record<string, IndustryData> = {
  "automotive-painting": {
    ...
    metaTitle: "Robotic Painting for Automotive Parts | Class A Finish | TD",
    metaDescription: "Eliminate Class A finish inconsistency with robotic spray cells. Electrostatic or HVLP systems for brackets, trim, housings. 50-70% less labor.",
  ...
  "metal-parts-finishing": {
    ...
    metaTitle: "Paint Booth Automation for Metal Parts Finishing | TD",
    metaDescription: "Uneven film build and corrosion failures on metal parts? Robotic spray systems with airless or HVLP for steel, aluminum, cast iron. 15-30% material savings.",
  ...
  "appliance-coating": {
    ...
    metaTitle: "Appliance Painting Automation | Fast Color Change | TD",
    metaDescription: "Frequent color changeovers killing throughput? Robotic appliance painting with <60s color change, electrostatic bell atomizers. 60-80% labor reduction.",
  ...
  "construction-machinery": {
    ...
    metaTitle: "Heavy Equipment Painting Automation | Rail-Mounted Robots | TD",
    metaDescription: "Large parts (2-12m) need rail-mounted robots for consistent protective coating. Achieve ±5 micron DFT, 25-40% paint savings, 14-20 month ROI.",
  ...
  "automotive-exterior-parts": {
    ...
    metaTitle: "Plastic & Composite Painting | Flame Treatment | TD",
    metaDescription: "Coating adhesion failures on plastic parts? Integrated flame/plasma prep with robotic spray. 90%+ adhesion failure reduction, 12-18 month ROI.",
    ...
    faqs: [
      ...
      { question: "Can electrostatic painting work on non-conductive plastics?", answer: "Yes, with conductive primers or specialized techniques to enable electrostatic wraparound and improved transfer efficiency." },

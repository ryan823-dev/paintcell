...
export default function UAEMarketPage() {
    ...
    return (<ResourcePageLayout title="Industrial Robotic Paint Automation for UAE & Middle East" metaTitle="Robotic Paint Booth UAE | Industrial Coating Systems Middle East" metaDescription="Premium robotic spray painting automation for UAE and Gulf region. Complete turnkey solutions meeting GCC standards, supporting industrial diversification under Vision 2030 with international quality certification." breadcrumbs={[

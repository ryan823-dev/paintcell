...
const groundFaqs = [
  ...
  { q: "How does electrostatic painting relate to grounding?", a: "Electrostatic spray guns charge paint particles to 60-100 kV. The grounded workpiece attracts charged particles, improving transfer efficiency. Without proper grounding of the part and fixtures, wrap-around effect is lost and charge buildup creates safety hazards." },

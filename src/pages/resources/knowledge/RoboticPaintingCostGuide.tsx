...
export default function RoboticPaintingCostGuide() {
  ...
  return (
    <ResourcePageLayout
      title={article.title || "Robotic Painting Cost Guide"}
      metaTitle={article.metaTitle || "Robotic Painting Cost Guide | Technical Insights | TD"}
      metaDescription={article.metaDesc || "Expert guide on robotic painting system costs. Covers capital investment breakdown, operating costs, ROI calculation methodology, and cost optimization strategies."}
      breadcrumbs={[
        { label: "Engineering Library", href: "/resources/engineering-library" },
        { label: "Knowledge" },
        { label: article.title || "Robotic Painting Cost Guide" },
      ]}
    ...
    >
      ...
      <p className="text-muted-foreground mb-4">A complete robotic painting system investment consists of several major categories:</p>

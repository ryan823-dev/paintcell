...
export default function HowToDesignATEXCompliantSprayPaintingBooth() {
  const structuredData = {
    ...
    "@type": "TechArticle",
    headline: "How to Design an ATEX-Compliant Spray Painting Booth",
    description: "Design guide for ATEX-compliant spray painting booths covering airflow, zoning, controls, and retrofit scope.",
  };

  return (
    <ResourcePageLayout
      title="How to Design an ATEX-Compliant Spray Painting Booth"
      metaTitle="How to Design an ATEX-Compliant Spray Painting Booth | Design Guide"
    ...
    >
      ...
      <p className="text-muted-foreground mb-8">
        ...
        <Link to="/resources/knowledge/atex-spray-painting-booth" className="ml-1 text-primary underline underline-offset-4">ATEX zone classification for spray painting booths</Link>,

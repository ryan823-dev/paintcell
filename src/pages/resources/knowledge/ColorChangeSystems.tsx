...
export default function ColorChangeSystems() {
  ...
  return (
    <ResourcePageLayout
      title={article.title || "Color Change Systems in Robotic Painting"}
      metaTitle={article.metaTitle || "Color Change Systems in Robotic Painting: Types, Selection & ROI | TD"}
      metaDescription={article.metaDesc || "Complete guide to paint color change systems for robotic spray painting. Compare manual, quick-disconnect, automatic, and pigging systems with changeover times and ROI analysis."}
      breadcrumbs={[
        { label: "Engineering Library", href: "/resources/engineering-library" },
        { label: "Knowledge" },
        { label: "Color Change Systems" },
      ]}
      structuredData={structuredData}
      canonicalPath="/resources/knowledge/color-change-systems"
    >
      {/* Meta info */}

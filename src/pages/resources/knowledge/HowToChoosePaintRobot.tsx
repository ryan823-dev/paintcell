...
export default function HowToChoosePaintRobot() {
  ...
  const articleSchema = {
    ...
    "@type": "TechArticle",
    "headline": article.metaTitle || "How to Choose a Paint Robot for Industrial Spray Painting",
  ...
  return (
    <ResourcePageLayout
      title={article.title || "How to Choose a Paint Robot for Industrial Spray Painting"}
      metaTitle={article.metaTitle || "How to Choose a Paint Robot | Technical Insights | TD"}
      metaDescription={article.metaDesc || "Expert guide on selecting industrial painting robots. Covers robot types, key specifications, selection criteria, and common mistakes. Downloadable checklist included."}
      breadcrumbs={[
        { label: "Engineering Library", href: "/resources/engineering-library" },
        { label: "Knowledge" },
        { label: article.title || "How to Choose a Paint Robot" },
      ]}
    ...
    >
      ...
      <p className="text-muted-foreground mb-4">Industrial painting robots are purpose-built 6-axis articulated robots designed for operation in explosive atmospheres. Unlike general industrial robots, they feature:</p>
      <ul className="space-y-2 mb-6 list-disc pl-6 text-muted-foreground">
      ...
      <p className="text-muted-foreground">Major manufacturers offering dedicated painting robots include ABB (IRB 5500), FANUC (P-series), Kawasaki (KJ-series), and Yaskawa (MPX-series). Each has strengths in different reach/speed ranges.</p>

...
import {
  ...
  AlertTriangle, CheckCircle2, Eye, Droplets, Wind, Thermometer
} from "lucide-react";
...
const schemas_static = [
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "@id": `${DOMAIN}/resources/knowledge/paint-defects-guide#breadcrumb`,
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Paint Defects Guide", item: `${DOMAIN}/resources/knowledge/paint-defects-guide` },
    ],
  },
];
        ...
        <section className="border-b border-border">
          <div className="container-wide py-12 md:py-16">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-[2.75rem] font-bold mb-6 leading-tight">
              Paint Defects Guide: Identification, Causes & Prevention
            </h1>
        ...
        <section className="border-b border-border ">
          <div className="container-wide py-12">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <Link to="/resources/knowledge/spray-technology-guide" className="group">
                <Card className="border-border bg-card h-full transition-colors group-hover:border-accent/40">
                  <CardContent className="p-4">
                    <h3 className="font-semibold text-sm mb-1 group-hover:text-accent">Spray Technology Guide</h3>
